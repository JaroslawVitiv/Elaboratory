	    	...
	    	<a  class="navbar-brand" href="/cinema">
		     ...
		     <div>
				<form class="form-inline" action="/administration" >
				  <span><input type="date" id="start" class="form-control"  value="<%  out.print(currentdate); %>" max="<%  out.print(currentdate); %>" name="start"   /></span>
					  <span>
				  ...
				  <span><input type="date" id="end" class="form-control"  value="<%  out.print(currentdate); %>" max="<%  out.print(currentdate); %>" name="end"   /></span>
